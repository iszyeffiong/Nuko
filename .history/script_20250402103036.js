...
function doGet(e) {
    ...
    try {
      ...
      var sheet = spreadsheet.getSheetByName("Whitelist");
      ...
      var addressRange = sheet.getRange(2, 1, lastRow - 1, 1);
      var addressValues = addressRange.getValues();
      
      var addresses = addressValues.flat()
  ...
  function doPost(e) {
    ...
    try {
      ...
      var walletAddress = params.walletAddress;
      ...
      var lastRow = sheet.getLastRow();
      sheet.getRange(lastRow + 1, 1).setValue(walletAddress);
